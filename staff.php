...
<head>
    ...
    <title>Staff Directory - Clinic Management System</title>
            ...
            <!-- <header class="header">
                <div class="search-container">
                    <div class="search-wrapper">
                        ...
                        <input class="search-input" placeholder="Search staff by name, department or ID..."
                            type="text" />
                    </div>
                </div>
                <div class="header-actions">
                    <button class="btn-primary">
                        <span class="material-symbols-outlined">person_add</span> Add New Staff
                    </button>
            ...
            <div class="content-body">
                <div class="page-header">
                    <div>
                        ...
                        <p class="page-desc">Manage and view all medical professionals and clinical staff.</p>
                    </div>
                ...
                <div class="department-filter">
                    <button class="filter-chip active">All Staff</button>
                    <button class="filter-chip">Cardiology</button>
                    <button class="filter-chip">Pediatrics</button>
                    <button class="filter-chip">Neurology</button>
                    <button class="filter-chip">Radiology</button>
                    <button class="filter-chip">General Surgery</button>
                    <button class="filter-chip">Psychiatry</button>
            ...
            <footer class="footer">
                <div class="footer-content">
                    <div class="stats-group">
                        <div>
                            <div class="stat-item-val">124</div>
                            <div class="stat-item-lbl">Total Staff</div>
                        </div>
                        <div>
                            <div class="stat-item-val">18</div>
                            <div class="stat-item-lbl">Departments</div>
                        </div>
                        <div>
                            <div class="stat-item-val">94%</div>
                            <div class="stat-item-lbl">Attendance</div>
                        </div>
                    </div>
                    <div class="copyright">
                        © 2024 Medical Systems Admin Portal. v2.4.0
                    </div>
                </div>
            </footer>
        </main>
